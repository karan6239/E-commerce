// ==========================================================================
// NOVA FASHION - UNIFIED CLIENT-SIDE ENGINE & STATE MANAGEMENT (SHOES)
// ==========================================================================
...
function initProductInteractions() {
    ...
    cards.forEach((card, index) => {
        ...
        const category = catEl?.innerText.trim().toLowerCase() || document.querySelector('.item-shop')?.getAttribute('data-category') || 'shoes';

        const productObj = {
            id: card.getAttribute('data-id') || (index + 300),
            name: name,
            price: priceText,
            priceNum: priceNum,
            image: image,
        ...
        if (addBtn) {
            addBtn.onclick = (e) => {
                e.stopPropagation();
                addProductToCart(productObj, 'UK 9', 1);
        ...
        if (imgEl) {
            imgEl.onerror = () => {
                imgEl.src = 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=800&auto=format&fit=crop&q=80';
            };
        }
    });
}
